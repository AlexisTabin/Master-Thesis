...
\affiliation[inst1]{organization={Department of Computer Science},%Department and Organization
            addressline={ETH Zürich}, 
            city={Zürich},
            country={Switzerland}}

\author[inst2]{Patrick Langer}

\affiliation[inst2]{organization={Center for Digital Health Interventions},%Department and Organization
            addressline={Department of Management, Technology, and Economics}, 
            city={ETH Zurich},
            state={Zurich},
            country={Switzerland}}
